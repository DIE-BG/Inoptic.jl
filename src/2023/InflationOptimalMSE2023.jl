...
InflationOptimalFixedExclusionMSE2023 = InflationFixedExclusionCPI{4}(
    (
...
InflationOptimalMSE2023 = let
    ...
    components = [
        ...
        InflationOptimalFixedExclusionMSE2023,
    ...
    optmse2023 = CombinationFunction(
        components...,
        mse_weights,
        "Optimal MSE Linear Combination (2023 Edition)",
        "OPTMSE23"
    )
...
InflationOptimalMSE2023_ci = DataFrame(
    ...
    evalperiod = [Date(2001, 12):Month(1):Date(2010, 12), Date(2011, 1):Month(1):Date(2011, 11), Date(2011, 12):Month(1):Date(2023, 12)],
