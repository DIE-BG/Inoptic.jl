...
InflationOptimalCORR2024 = let
    ...
    ENSEMBLE1 = [
        ...
        InflationCoreMaiF(GTDATA, [0.0, 0.25, 0.5, 0.75, 1.0]),
        InflationCoreMaiFG(GTDATA, [0.0, 0.25, 0.5, 0.75, 1.0]),
        InflationCoreMaiG(GTDATA, [0.0, 0.25, 0.5, 0.75, 1.0]),
    ]
    ...
    InflationOptimalCORR2024 = InflationSpliceUnweighted(
        [c1, c2, c2];
        name = "Optimal CORR Linear Combination (2024 Edition)",
        tag = "InflationOptimalCORR2024"
    )
