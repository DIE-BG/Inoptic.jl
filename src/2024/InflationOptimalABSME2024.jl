...
InflationOptimalABSME2024 = let
    ...
    ENSEMBLE1 = [
        ...
        InflationCoreMaiF(GTDATA, [0.0, 0.01443501550099045, 0.4054140156662617, 0.40962401341704674, 0.9926516774108755, 1.0]),
        InflationCoreMaiFG(GTDATA, [0.0, 0.35859786931406085, 0.6110773114491551, 0.9199836222660053, 1.0]),
        InflationCoreMaiG(GTDATA, [0.0, 0.16666666666666666, 0.3333333333333333, 0.5, 0.6666666666666666, 0.8333333333333334, 1.0]),
    ]
    ...
    optabsme2024 = InflationSpliceUnweighted(
        [c1, c2, c2];
        name = "Optimal ABSME Linear Combination (2024 Edition)",
        tag = "InflationOptimalABSME2024"
    )
