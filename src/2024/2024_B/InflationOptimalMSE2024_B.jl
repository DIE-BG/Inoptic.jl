...
w_23 = [0.263375  0.116192  0.230044  0.155348  0.173277 0.0][:]
#w_23_2  = [0.482095  0.0553004  0.289238  1.81019f-7  0.173366][:] #conjunto mejor optimizado
...
ENSEMBLE1 = [
    ...
    InflationCoreMaiF(GTDATA00, [0.0, 0.006287041634702409, 0.4763169240418438, 0.8411085012613978, 1.0]),
    InflationCoreMaiFG(GTDATA00, [0.0, 0.30007700254937775, 0.3806979438933833, 0.6592801609973685, 0.8572920039185152, 1.0]),
    InflationCoreMaiG(GTDATA00, [0.0, 0.2658236991960707, 0.5601153961330196, 0.8278967604925729, 1.0]),
]
...
ENSEMBLE2 = [
    ...
    InflationCoreMaiF(GTDATA_CALIB_2024, [0.0, 0.5284098303517797, 0.5601390976116516, 0.8452089641556906, 0.9993493866637225, 1.0]),
    InflationCoreMaiFG(GTDATA_CALIB_2024, [0.0, 0.31862161044309834, 0.4455906849926661, 0.8172109274523476, 1.0]),
    InflationCoreMaiG(GTDATA_CALIB_2024, [0.0, 0.42007669750748233, 0.5, 0.7913978925837042, 1.0]),
]
