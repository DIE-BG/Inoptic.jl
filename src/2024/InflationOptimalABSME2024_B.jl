# Optimal linear combination ABSME 2024 B
...
w_23 = [0.693705  0.298789  0.002632  0.002504  0.002368893 0.0][:]
...
ENSEMBLE1 = [
    ...
    InflationCoreMaiF(GTDATA00, [0.0, 0.01443501550099045, 0.4054140156662617, 0.40962401341704674, 0.9926516774108755, 1.0]),
    InflationCoreMaiFG(GTDATA00, [0.0, 0.35859786931406085, 0.6110773114491551, 0.9199836222660053, 1.0]),
    InflationCoreMaiG(GTDATA00, [0.0, 0.16666666666666666, 0.3333333333333333, 0.5, 0.6666666666666666, 0.8333333333333334, 1.0]),
]
...
ENSEMBLE2 = [
    ...
    InflationFixedExclusionCPI{4}(([35, 30, 190, 36, 37, 40, 31, 104, 162], [29, 31, 116, 39, 46, 40], [65, 69, 71, 77, 80, 195], [64, 68, 70, 76, 79, 194])),
    InflationCoreMaiF(GTDATA, [0.0, 0.379280146972861, 0.4638464024329255, 0.6627648560234276, 0.9992936015281153, 1.0]),
    InflationCoreMaiFG(GTDATA, [0.0, 0.3157767072323891, 0.39533970890059356, 0.5325194928987427, 0.8020712456196974, 0.9683431434693862, 1.0]),
    InflationCoreMaiG(GTDATA, [0.0, 0.3827623832395122, 0.46567742156161374, 0.7436252875246401, 1.0]),
]
...
InflationOptimalABSME2024_ci = DataFrame(
